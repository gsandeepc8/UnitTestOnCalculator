...
import com.nit.unittest.CalculatorTestClass1;
import com.nit.unittest.CalculatorTestClass2;

public class LakanXlReportTestClass {
	public static void main(String[] args) {
		Result result = JUnitCore.runClasses(CalculatorTestClass1.class,CalculatorTestClass2.class);
		Workbook wb = null;
		...
		try {
			out = new FileOutputStream(new File("lakhanXL//TestReport.xlsx"));
			wb.write(out);
			out.close();
			wb.close();
